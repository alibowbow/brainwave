...
export const NATURE_SAMPLE_ASSETS = {
  ...
  creekBrook: {
    ...
    processingCommand: 'ffmpeg -i creek.wav -af volume=5.8dB -ar 48000 -ac 2 -> Vorbis q4 + MP3 96k; v2 remaster: browser decode → +9.5 dB gain + tanh soft-limit (knee -9 dBFS, ceiling -5 dBFS) → lamejs MP3 112k',
    distributedSourceSha256: '3926d7cf09975740dc39baec395a4117ea06a8f4a322978a44798b3245863777',
    sources: [
      { fileName: 'creek-brook-cc0-v2.mp3', mimeType: 'audio/mpeg', codec: 'MP3', bitrateKbps: 112, sha256: '96ffdaca13147db424ee9ab2ea3113d00f547e725e493b32162ae12ad470367f', role: 'universal' },
    ],
    sampleTrim: 1, crossfadeSeconds: 1.1, durationSeconds: 25.06, channels: 2, sampleRate: 48_000,
    decodedBytesEstimate: 9_623_040, integratedLufs: -21.2, truePeakDbtp: -5,
  },
  fireplaceHearth: {
    playback: 'loop',
...
export const NATURE_SAMPLE_BINDINGS: Partial<Record<BackgroundSoundType, NatureSampleBinding>> = {
  ...
  stream: { assetIds: ['creekBrook'], sampleScale: 1, proceduralMix: 0.45 },
